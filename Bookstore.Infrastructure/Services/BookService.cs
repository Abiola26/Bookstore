...
public class BookService : IBookService
{
    ...
    public async Task<ApiResponse<BookResponseDto>> UpdateBookAsync(Guid id, BookUpdateDto dto, CancellationToken cancellationToken = default)
    {
        ...
        try
        {
            ...
            if (dto.PublicationDate.HasValue)
                book.PublicationDate = dto.PublicationDate.Value.ToUniversalTime();
    ...
    public async Task<ApiResponse<BulkUploadResultDto>> BulkUploadBooksAsync(Stream csvStream, CancellationToken cancellationToken = default)
    {
    ...
    public byte[] GetBulkUploadTemplate()
    {
        ...
        return System.Text.Encoding.UTF8.GetBytes(header + sampleRow);
    }
